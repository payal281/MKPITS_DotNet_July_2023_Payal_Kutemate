...
insert into Student values       
 ('Luisa', 'Evans', 13000, 'Texas',25,3354),       
	...
	select Student.admission_no,Student.fname,Student.lname,admission.course,admission.amount_paid from Student cross join admission where Student. admission_no = admission.admission_no